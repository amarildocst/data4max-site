...
## 🚀 Funcionalidades
- [Menu responsivo](ca://s?q=Menu_hamburguer_responsivo) com hamburguer no mobile e centralização no desktop.
- [Modo escuro persistente](ca://s?q=Modo_escuro_com_localStorage) (manual e automático via `prefers-color-scheme`).
- [Scroll suave](ca://s?q=Scroll_suave_em_sites) entre seções.
...
3. Certifique-se de que os arquivos `index.html`, `css/style.css` e `js/script.js` estão na estrutura correta.
...
## 🚀 Features
- [Responsive menu](ca://s?q=Responsive_menu_with_hamburger) with hamburger navigation on mobile and centered layout on desktop.
- [Persistent dark mode](ca://s?q=Dark_mode_with_localStorage) (manual toggle and automatic via `prefers-color-scheme`).
- [Smooth scrolling](ca://s?q=Smooth_scrolling_in_websites) between sections.
...
3. Ensure that `index.html`, `css/style.css`, and `js/script.js` are in the correct structure.
...
## 📜 License
This project is for academic and community use, linked to the Extension Project of the Partner University.
